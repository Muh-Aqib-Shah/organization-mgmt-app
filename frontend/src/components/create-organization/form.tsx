...
interface CreateOrganizationFormProps {
  form: UseFormReturn<OrganizationFormType>;
  selectedType: OrgType;
  isLoading: boolean;
  onSubmit: (data: OrganizationFormType) => void;
}
interface CardType {
  id: string;
  label: string;
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-1.5 space-y-0">
                    ...
                    <FormDescription className="text-xs text-gray-400 font-normal leading-normal select-none -mt-0.5">
                      Specify the formal school district administration region
                      name parameters.
                    </FormDescription>
                    <FormControl>
                      <div className="relative flex items-center w-full group mt-1">
